...
describe('Recipes', function() {
  ...
  it('should add a new recipe to the list on POST', function() {
    const newRecipe = {name: 'lemon cake', ingredients: ['lemons', 'eggs', 'sugar', 'flour']}
    return chai.request(app)
      .post('/recipes')
      .send(newRecipe)
      .then(function(res) {
  ...
  it('should update an existing recipe on PUT', function() {
    ...
    const updatedRecipe = {
      name: 'milkshake',
      ingredients: ['1 cup bananas', '1 cups vanilla ice cream', '1 cup milk']
    }
